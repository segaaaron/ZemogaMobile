...
public class ZenogaConfig {
    ...
    static let spacelevel4: CGFloat = 20
    static let spacelevel5: CGFloat = 25
    static let spacelevel6: CGFloat = 30
    static let spacelevel7: CGFloat = 35
    
    static let widhtSpaceLv1: CGFloat = 70
